...
public class Main extends javax.swing.JFrame {
 private final ExecutorService executorService = Executors.newFixedThreadPool(5);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Foundation Hospital");
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
     ...
     private class TimeConsumingTask implements Runnable {
        @Override
        public void run() {
            // Replace this with your actual time-consuming task
            try {
                Thread.sleep(2000); // Simulating a time-consuming task for 5 seconds
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        executorService.submit(new TimeConsumingTask());
        // Patient p = new Patient();
        // p.setVisible(true);
        // dispose();
    ...
    private void formWindowClosing(java.awt.event.WindowEvent evt) {
        // Shut down the executor service when the window is closing
